...
export default {
  ...
  computed: {
    ...
    finalScore() {
      if (this.didWin && this.lives === 5) return 20;
      if (this.didWin && this.lives === 4) return 15;
      if (this.didWin && this.lives === 3) return 10;
      if (this.didWin && this.lives === 2) return 8;
      if (this.didWin && this.lives === 1) return 4;
      return 0;
    },
  },
  async mounted() {
